...
class TestEntityDiscoveryHelper:
    ...
    @pytest.mark.asyncio
    async def test_discover_entities_device_dali_gateway_error(self, mock_gateway):
    ...
    @pytest.mark.asyncio
    async def test_discover_entities_device_general_exception(self, mock_gateway):
    ...
    def test_prepare_entity_selection_schema_empty_entities(self):
        ...
        schema = EntityDiscoveryHelper.prepare_entity_selection_schema(
            devices=[], groups=[], scenes=[], existing_selections=None, show_diff=False
        )
    ...
    def test_prepare_entity_selection_schema_group_formatting(self, mock_groups):
    ...
    def test_prepare_entity_selection_schema_scene_formatting(self, mock_scenes):
    ...
    def test_prepare_entity_selection_schema_removed_groups(self, mock_groups):
    ...
    def test_prepare_entity_selection_schema_removed_scenes(self, mock_scenes):
    ...
    def test_filter_selected_entities_partial_selection(
        ...
        user_input = {
            "devices": [mock_devices[0]["unique_id"], mock_devices[1]["unique_id"]]
        }
        discovered_entities = {
            "devices": mock_devices,
            "groups": mock_groups,
    ...
    def test_filter_selected_entities_missing_entity_types(self, mock_devices):
        user_input = {
            "devices": [mock_devices[0]["unique_id"]],
            "groups": ["some_group_id"],  # Not in discovered_entities
            "scenes": ["some_scene_id"],  # Not in discovered_entities
        }
        discovered_entities = {"devices": mock_devices}
